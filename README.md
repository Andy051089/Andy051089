...
-   Education
    -   Taipei Medical University, Institute of Data Science (2024 - Present)
        ...
        -   Core Technologies : Imbalanced data handling, Graph neural networks (GNNs), Transfer learning, Large language models (Prompt engineering and LoRA), Explainable AI
-   Working Experience
...
![MS SQL](https://img.shields.io/badge/MS%20SQL-CC2927?style=for-the-badge&logo=microsoft-sql-server&logoColor=white) ![DuckDB](https://img.shields.io/badge/DuckDB-FFF000?style=for-the-badge&logo=DuckDB&logoColor=black) 
-   AI
